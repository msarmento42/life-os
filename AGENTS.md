...
- SQLite WAL mode is enabled — do not change PRAGMA settings
- Verification: `flake8 . --max-line-length=120 --exclude=__pycache__,frontend` and `cd frontend && npm run build`
